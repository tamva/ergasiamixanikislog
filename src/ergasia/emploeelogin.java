...
public class emploeelogin extends JFrame {
	 ...
	 */
	public static void emploeeenter() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					emploeelogin frame = new emploeelogin();
	...
	public emploeelogin() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
						...
						{
						String query="select * from login where username=? and password=? and job = 'emploee'";
